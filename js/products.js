// ============================================
// ملف المنتجات الافتراضية - WT Store
// ============================================
...
var PRODUCTS = savedProducts ? JSON.parse(savedProducts) : [
  { 
    ...
    shortDesc: "صوت نقي وباس قوي مع عزل ضوضاء", 
    description: "سماعة رأس لاسلكية بتقنية بلوتوث 5.3.", 
    specs: ["بلوتوث 5.3", "بطارية 40 ساعة"] 
  },
  { 
    id: 2, 
    ...
    shortDesc: "تتبع اللياقة والصحة بشاشة AMOLED", 
    description: "ساعة ذكية مقاومة للماء.", 
    specs: ["شاشة AMOLED", "IP68"] 
  },
  { 
    id: 3, 
    ...
    shortDesc: "خفيفة ومريحة مع علبة شحن", 
    description: "سماعات أذن لاسلكية صغيرة الحجم.", 
    specs: ["بلوتوث 5.2", "تحكم باللمس"] 
  },
  { 
    id: 4, 
    ...
    shortDesc: "صوت قوي 360 درجة مناسب للرحلات", 
    description: "مكبر صوت محمول مقاوم للماء.", 
    specs: ["بلوتوث 5.0", "صوت 360 درجة"] 
  }
];
